(function($){
	...
	*/
	...
	$.fn.simplemusic=function(settings){
		$(this).css({"z-index":"999","width":"44px","height":"44px","position":"fixed","bottom":"22px","right":"10px","cursor":"pointer","background":"url(./public/o_music_note_big.png)"}).bind("click",function(){
			if(_playstatus){
				pause(this);
			}else{
				play(this);
